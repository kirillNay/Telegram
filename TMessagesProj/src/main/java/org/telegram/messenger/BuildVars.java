...
public class BuildVars {
    ...
    public static int APP_ID = 18662834;
    public static String APP_HASH = "3f4d1d3b893015a814330a8919832e3e";
    ...
    public static boolean isBetaApp() {
        if (betaApp == null) {
            betaApp = ApplicationLoader.applicationContext != null && "nay.kirill.telegram.beta".equals(ApplicationLoader.applicationContext.getPackageName());
        }
        return betaApp;
    }
